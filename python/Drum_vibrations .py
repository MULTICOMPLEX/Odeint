...
ani = FuncAnimation(fig, update, init_func=init, frames=FRAMES, interval=1000/FPS, repeat_delay=0, fargs=(bar, ))

ani.save(
    f'c:/ffmpeg/movies/membrane.mp4',
    writer='ffmpeg',
    extra_args=['-vcodec', 'libx264', '-preset', 'slower', "-pix_fmt", "yuv420p", "-crf", "24", "-threads", "0", "-bf", "0"]
)
'''
ani.save('c:/ffmpeg/movies/membrane.gif')
